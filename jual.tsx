...
const Produk = () => {
  const [ProdukData, setProdukData] = useState<{ nim: string; nama: string; alamat: string; tanggal_lahir: string; foto?: string }[]>([]);
  ...
  const handleSubmitEdit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const address = '/' + event.currentTarget.nim.value;
    const formData = {
      nim: event.currentTarget.nim.value,
      nama: event.currentTarget.nama.value,
      alamat: event.currentTarget.alamat.value,
      tanggal_lahir: event.currentTarget.tanggal_lahir.value,
    };
    koneksitoko
  ...
  const handleSubmitAdd = (formData: FormData) => {
    koneksitoko
      .post('/', formData, {
        headers: {
